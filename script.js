const translations = {
    ...
    fr: {
        ...
        legalInfo: "<h2>Droits Juridiques</h2>Les étudiants internationaux ont des droits et des obligations légales pendant leurs études en France. Ils doivent maintenir une inscription universitaire active et respecter les conditions de leur visa ou titre de séjour. La plupart des étudiants étrangers peuvent travailler à temps partiel pendant leurs études, toujours dans la limite légale autorisée.<br><br><strong>Il est très important de conserver des copies numériques et physiques de tous les documents administratifs :</strong><ul><li>Visa et passeport</li><li>Contrat de location</li><li>Assurance maladie</li><li>Certificat de scolarité</li><li>Numéro de sécurité sociale</li><li>Compte bancaire et RIB</li></ul>En caso de problemas administrativos, de refus de visa ou de difficultés juridiques, il existe des avocats spécialisés et des services universitaires de soutien pour les étudiants étrangers. Certaines expériences montrent que les processus administratifs français peuvent être lents, il est donc recommandé de commencer toutes les démarches à l'avance."
